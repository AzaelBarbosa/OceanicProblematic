...
// nuevas zonas -------------------------------------------------------------------------------------
var caboPulmo = L.polygon([
    [23.373774, -109.425201],
    [23.493477, -109.460907],
    [23.497255, -109.302979],
    [23.371253, -109.297485]
]).addTo(map).bindPopup('CABO PULMO');
var ojoLiebre = L.polygon([
    [27.803854, -114.428101],
    [27.550894, -113.976288],
    [27.711494, -113.89389],
    [27.873073, -114.084778],
    [28.082885, -113.991394],
    [28.327351, -114.080658],
    [28.08652, -114.121857],
    [27.865789, -114.308624]
]).addTo(map).bindPopup('COMPLEJO LAGUNAR OJO DE LIEBRE');
var islaGuadalupe = L.circle([29.050167, -118.282928], {
    color: '#11AF25',
    fillColor: '#11AF25',
    fillOpacity: 0.7,
    radius: 30000
}).addTo(map).bindPopup('ISLA GUADALUPE');

// Coloración del mapeado
islaCozumel.setStyle({color: '#11AF25', fillColor: '#11AF25', fillOpacity: 0.7});
arrecifeCozumel.setStyle({color: '#11AF25', fillColor: '#11AF25', fillOpacity: 0.7});
arrecifePuertoMorelos.setStyle({color: '#11AF25', fillColor: '#11AF25', fillOpacity: 0.7});
YumBalam.setStyle({color: '#11AF25', fillColor: '#11AF25', fillOpacity: 0.7});
arrecifeXcalak.setStyle({color: '#11AF25', fillColor: '#11AF25', fillOpacity: 0.7});
pntCancunNizuc.setStyle({color: '#11AF25', fillColor: '#11AF25', fillOpacity: 0.7});
islaContoy.setStyle({color: '#11AF25', fillColor: '#11AF25', fillOpacity: 0.7});
tulum.setStyle({color: '#11AF25', fillColor: '#11AF25', fillOpacity: 0.7});
arrecifeSiankaan.setStyle({color: '#11AF25', fillColor: '#11AF25', fillOpacity: 0.7});
Siankaan.setStyle({color: '#11AF25', fillColor: '#11AF25', fillOpacity: 0.7});
tiburonBallena.setStyle({color: '#11AF25', fillColor: '#11AF25', fillOpacity: 0.7});
manglarNichupte.setStyle({color: '#11AF25', fillColor: '#11AF25', fillOpacity: 0.7});
golfoCalifornia.setStyle({color: '#11AF25', fillColor: '#11AF25', fillOpacity: 0.7});
arrecifeVeracruzano.setStyle({color: '#11AF25', fillColor: '#11AF25', fillOpacity: 0.7});
caboPulmo.setStyle({color: '#11AF25', fillColor: '#11AF25', fillOpacity: 0.7});
ojoLiebre.setStyle({color: '#11AF25', fillColor: '#11AF25', fillOpacity: 0.7});
